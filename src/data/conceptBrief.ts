...
export const BRIEF_QUESTIONS: BriefQuestion[] = [
  {
    ...
    options: [
      SURPRISE,
      {
        id: 'supercars',
        label: 'Supercars',
        prompt: 'Draw on iconic supercar and sports-car design: famous paint schemes, stripes and racing heritage.',
      },
      ...
      { id: 'jdm', label: 'JDM & street', prompt: 'Draw on Japanese car culture and street-racing style.' },
      { id: 'space', label: 'Space & sci-fi', prompt: 'Draw on space exploration and science fiction.' },
      { id: 'luxury', label: 'Luxury & stealth', prompt: 'Keep it premium and understated: satin, metallic and stealth finishes.' },
